...
**Fase incremental atual: Phase 31 — JWT post-issuance revocation**. Implementação e testes locais estão no working tree, ainda não commitados/mergeados; release permanece bloqueada por CI remoto.

**Phase 31 — JWT post-issuance revocation** (local verification passes; CI blocked; not merged)
