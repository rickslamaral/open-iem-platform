...
- PR #340 está aberta e sem merge; HEAD atual: `84233555e0dd879902c0d26dcd3b455560e5690d` (`develop`).
...
- `cargo test --manifest-path server/Cargo.toml -p streaming --lib`: 310 testes PASS localmente.
- Evidência CODE local; runtime WebRTC/DTLS-SRTP, PipeWire/ALSA, rede real e Raspberry Pi permanecem não validados.
...
- `cargo test --manifest-path server/Cargo.toml -p streaming --lib`: 280 testes PASS localmente.
- Evidência CODE local; runtime WebRTC/DTLS-SRTP, PipeWire/ALSA, rede real e Raspberry Pi permanecem não validados.
...
- `cargo test --manifest-path server/Cargo.toml -p streaming --lib`: 230 testes PASS localmente. Runtime WebRTC/DTLS-SRTP, PipeWire/ALSA, rede real e Raspberry Pi permanecem não validados.
...
- Gates pendentes neste checkpoint; evidência CODE local. Runtime WebRTC/DTLS-SRTP, PipeWire/ALSA, rede real e Raspberry Pi 5 permanecem não validados.
...
- Gate focado: teste streaming PASS; evidência CODE local. Runtime WebRTC/DTLS-SRTP, PipeWire/ALSA, rede real e Raspberry Pi permanecem não validados.
