...
- Verificação focused: `cargo test --manifest-path server/Cargo.toml -p streaming` — 260 testes PASS. Evidência CODE local; sem claim de runtime WebRTC/DTLS-SRTP, PipeWire/ALSA, rede real ou Raspberry Pi.
