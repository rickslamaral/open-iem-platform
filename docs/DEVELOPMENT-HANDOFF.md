...
| P0-004 | P0 | Receiver | Implement native/headless Opus receiver with output, jitter and reconnect | No receiver exists | ADR-002/003/004/006 | Decode, playout, mute-on-failure, pairing and reconnect | Receiver integration/fault tests | L1 then L3 | Yes |
...
**Next development item:** `P0-002 — L1/L2 Audio Lab`.
