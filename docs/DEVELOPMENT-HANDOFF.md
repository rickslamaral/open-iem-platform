...
**Current next step:** Define durable/transient lifecycle and operational backup/restore for SceneStore; file-backed persistence is implemented and covered by reopen testing. P1-007 code is merged (PR #73, CI run `34961804915`, CODE+CI/SIMULATED). Do not claim full acceptance: clean-environment restore and operational CLI/API remain pending. P1-006 release remains blocked by explicit confirmation and physical validation.
