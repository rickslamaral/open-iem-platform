...
- **P0-003 media handoff:** `MediaBridge`, bounded `SessionRegistry::drive_once`, `MediaWriter` Opus encoding and negotiated `str0m::media::Writer` boundary now exist at CODE/SIMULATED; socket transport, runtime and hardware remain pending.
...
- [ ] P0-003 — Media Plane: bounded bridge, session drive, Opus encoder and negotiated `str0m::media::Writer` handoff implemented (CODE/SIMULATED); socket transport, runtime and hardware remain pending.
