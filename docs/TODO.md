...
- Focused integration gate: 25 tests passed. Evidence is CODE local; real network, WebRTC/DTLS-SRTP, PipeWire/ALSA and Raspberry Pi hardware remain unvalidated.
