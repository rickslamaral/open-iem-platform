...
- [ ] LOW: WebSocket keepalive: add deterministic short-interval integration tests without waiting 30/60 seconds — política de timeout extraída, desafio Pong correlacionado e helpers cobertos; loop WS ainda pendente
