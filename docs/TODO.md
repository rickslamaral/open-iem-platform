...
- **P0-003 media handoff:** PR #119 merged. `MediaBridge`, bounded `SessionRegistry::drive_once`, `MediaWriter` Opus encoding and negotiated `str0m::media::Writer` boundary exist at CODE/SIMULATED; bounded transport-output ownership, socket transport, runtime and hardware remain pending.
...
- [ ] P0-003 — Media Plane: bridge/session/Opus/negotiated writer merged in PR #119 (CODE/SIMULATED); bounded transport-output ownership, socket transport, runtime and hardware remain pending.
