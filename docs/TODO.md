...
- [ ] Complete real amd64/arm64 `.deb` artifact matrix and package install/upgrade/uninstall/purge in clean containers. amd64 lifecycle evidence: PASS on 2026-09-19; arm64 artifact and lifecycle evidence: PASS in CI run 35533396414 (CODE + PACKAGE_RELEASE_GATE).
