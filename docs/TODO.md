...
- **P0-003 media handoff:** `streaming::MediaBridge` bounded non-blocking queue now routes `FrameOutput` to per-session media queues; WebRTC session drive and runtime remain pending.
