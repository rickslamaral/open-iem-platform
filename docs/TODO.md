...
- **P2 Preset catalog read-only:** `GET /api/v1/presets` Engineer/Admin e catálogo no Engineer Console; aplicação/mutação permanece fora do escopo. Evidência CODE local; runtime permanece pendente.
