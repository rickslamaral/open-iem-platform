...
|---|---|---|---|---|---|---|---|---|---|---|
| GAP-001 | P0 | Media | No production media path MixEngine→network | Bounded `streaming::MediaBridge` routes `FrameOutput` to per-session queues; no WebRTC media I/O | IMPLEMENTATION GAP | ADR-001/002/003 | 006,007 | Connect bridge to WebRTC media drive and frame bridge | Real media integration/L1–L4 | Yes |
