...
| GAP-031 | P2 | Docs | Phase reviews/guides incomplete | Canonical Phase review coverage now includes Phase 95; remaining historical review/guides still require reconciliation | IMPLEMENTATION GAP | Future docs task | registry | Reconcile remaining claims | Docs validator | No |
